...
hl.config({
	plugin = {
		hyprexpo = {
			...
			label_color = "0xf7f7f7f7",
			label_color_current = "0xf7f7f7f7",
			label_color_default = "0xf7f7f7f7",
			label_color_focus = "0xf7f7f7f7",
			label_color_hover = "0xf7f7f7f7",
			label_enable = true,
			...
			selection_label_color = "0xf7f7f7f7",
			...
			workspace_number_color = "0xf7f7f7f7",
		},
	},
})
