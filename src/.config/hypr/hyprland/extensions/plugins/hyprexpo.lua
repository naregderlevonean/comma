...
hl.config({
	plugin = {
		hyprexpo = {
			...
			label_color_current = "0xedededed",
			label_color_default = "0xedededed",
			label_color_focus = "0xedededed",
			label_color_hover = "0xedededed",
			label_enable = true,
			...
			selection_label_color = "0xedededed",
			...
			workspace_number_color = "0xedededed",
		},
	},
})
