...
hl.config({
	plugin = {
		hyprexpo = {
			animate_entry = false,
			bg_col = "0xed090909",
			border_color = "0xed090909",
			border_color_current = "0xed090909",
			border_color_focus = "0xed090909",
			border_color_hover = "0xed090909",
			border_width = 0,
			cancel_key = "escape",
			columns = 4,
			drag_drop_proxy_active_color = "0xed090909",
			drag_drop_proxy_border_color = "0xed090909",
			drag_drop_proxy_border_width = 0,
			drag_drop_proxy_color = "0xed090909",
			drag_drop_proxy_rounding = 96,
			drag_drop_source_border_color = "0xed090909",
			...
			keynav_wrap_h = true,
			keynav_wrap_v = true,
			label_bg_color = "0xed090909",
			label_bg_enable = true,
			label_bg_rounding = 8,
			label_bg_shape = "circle",
			label_center_adjust_x = 0,
			label_center_adjust_y = 0,
			label_color = "0xf7f8f8f8",
			label_color_current = "0xf7f8f8f8",
			label_color_default = "0xf7f8f8f8",
			label_color_focus = "0xf7f8f8f8",
			label_color_hover = "0xf7f8f8f8",
			label_enable = true,
			...
			selection_label_color = "0xf7f8f8f8",
			...
			workspace_number_color = "0xf7f8f8f8",
		},
	},
})
